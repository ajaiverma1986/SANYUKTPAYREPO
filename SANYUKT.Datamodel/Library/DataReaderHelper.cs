...
namespace SANYUKT.Datamodel.Library
{
    public class DataReaderHelper
    {
        ...
        internal long GetDataReaderValue_Long(object reader, string v)
        {
        ...
        public TimeSpan GetDataReaderValue_Time(SqlDataReader reader, string ColumnName)
        {
            if (reader[ColumnName] != null || reader[ColumnName] != DBNull.Value)
            {
                if (ValidateTime(reader[ColumnName].ToString()))
        ...
        public Double GetDataReaderValue_Double(SqlDataReader reader, string ColumnName)
        {
            if (reader[ColumnName] != null || reader[ColumnName] != DBNull.Value)
            {
                if (ValidateDouble(reader[ColumnName].ToString()))
        ...
        public Guid? GetDataReaderNullValue_Guid(SqlDataReader reader, string ColumnName)
        {
            if (reader[ColumnName] != null || reader[ColumnName] != DBNull.Value)
            {
                if (ValidateGuid(reader[ColumnName].ToString()))
        ...
        public Guid GetDataReaderValue_Guid(SqlDataReader reader, string ColumnName)
        {
            if (reader[ColumnName] != null || reader[ColumnName] != DBNull.Value)
            {
                if (ValidateGuid(reader[ColumnName].ToString()))
